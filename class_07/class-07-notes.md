...
1. Attendance
2. Project #2 Concept due next Thursday

## Reading #2

> Burstein: Well one of the things that I was recently reading was an essay by Spider Robinson which points out that **_reading is actually difficult_**.

Dana Goldstein (2025): ["Reading Skills of 12th Graders Hit a New Low"](https://www.nytimes.com/2025/09/09/us/12th-grade-reading-skills-low-naep.html)

Jessica Grose (2025): ["The Unexpected Upside of Phone Bans in Schools"](https://www.nytimes.com/2025/09/17/opinion/phone-bans-schools-kids.html)

> The Jefferson County Public Schools in Kentucky this month announced a surprising unintended consequence of a new statewide cellphone ban. In many of the district’s schools, the **_number of books checked out in the first few weeks of class had skyrocketed compared with last year_**, before the ban was instituted.

> In 2001, Lev Manovich chastised scholars for focusing on future rather than already existing technologies—for conflating demo with reality, fiction with fact and Peter Lunenfeld and Geert Lovink categorized much theoretical work as “vapor theory,” their criticism seemed a much-needed admonishment. - Chun, pages 150 - 151

![Jacquard Loom](https://en.wikipedia.org/wiki/Jacquard_machine#/media/File:Telaio_Jacquard_1849.jpg)

> Before, the computer could read a row of numbers, outputting a statistical result or a gun trajectory. Now it can read pixel values, blurring the image, adjusting its contrast, or checking whether it contains an outline of an object. Building on these lower-level operations, it can also perform more ambitious ones searching image databases for images similar in composition or content to an input image, detecting show changes in a movie, or synthesizing the movie shot itself, complete with serving and actors. In a historical loop, the computer has returned to its origins. No longer just an Analytical Engine, suitable only for crunching numbers, it has become Jacquard's loom—a media synthesizer and manipulator. - Lev Manovich, [_The Language of New Media_](https://dss-edit.com/plu/Manovich-Lev_The_Language_of_the_New_Media.pdf) (page 26)

- [Jacquard Machine](https://en.wikipedia.org/wiki/Jacquard_machine)

In Groups of 3:

- What is the importance of computer literacy in new media art?
...
#### ACTIVITY: Where do you get your inspiration?

In this [shared doc](https://docs.google.com/document/d/1H-C6nP-m-5ewUTyI2rvWPGCUbZHnyKAg-sLEQGZ4PnY/edit?usp=sharing) take 5-10 minutes to add where you look/get/find news, inspiration, mood boards

add your name and a few links to places you check :)

#### CONSIDER: How do you organize and remember your research?
...
Now I am an [are.na](https://are.na) enjoyer. Some useful channels/people I follow:
...
- physical! journals are a fun archive way down the line
...
The more *time* you dedicate to thinking about the concept of a project can help! 

#### 3. Information Architecture + User Experience

##### sitemaps → blueprint / outline for your entire website. 

see https://kagi.com/images?q=sitemap
...
see https://kagi.com/images?q=wireframe
...
- Iterate on  your wireframe and test some high-fidelity designs *before* coding
...
##### How wide should text be on a webpage?
...
***Research requires time and attention***! Which is why AI tools are so compelling, because they can streamline and "optimize" your time. But we don't want to optimize, we want to be curious! In your blog, take note of each link you clicked on that you spent significant time with. These are the links that you will cite in your documentation.

## If time: Continue JavaScript

From [class 6 notes](https://samheckle.github.io/networked-media-fa-26/class_06/class_06_notes#selecting-an-element-on-the-page-using-the-dom)
